          ...
          <CardContent className="p-4 flex items-center">
            ...
            <div>
              ...
              <div className="flex items-center">
                <h3 className="text-2xl font-bold mr-2">86</h3>
                <span className="text-xs px-1.5 py-0.5 bg-green-100 text-green-600 rounded">+24%</span>
              </div>
              <p className="text-xs text-gray-500">Previous week: 42</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 flex items-center">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Previous week: 65</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 flex items-center">
            ...
            <div>
              ...
              <div className="flex items-center">
                <h3 className="text-2xl font-bold mr-2">195</h3>
                <span className="text-xs px-1.5 py-0.5 bg-green-100 text-green-600 rounded">+31%</span>
              </div>
              <p className="text-xs text-gray-500">Previous week: 142</p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            ...
            <div className="flex justify-between mb-2">
              <div className="text-center">
                <div className="bg-emerald-500 text-white rounded-full w-10 h-10 flex items-center justify-center mx-auto mb-1">
                  <span>5</span>
                </div>
                <p className="text-xs">
                  Room
        ...
        <Card>
          <CardContent className="p-4 flex items-center">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold">$26,500</h3>
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      >
        ...
        <div className="p-6 border-b border-gray-200">
          <h1 className="text-2xl font-semibold text-emerald-600">HotelPro</h1>
        </div>
        <div className="flex-1 py-4 overflow-y-auto">
          <nav className="space-y-1 px-2">
            <button
              onClick={() => setActiveSection("dashboard")}
              className={`flex items-center w-full px-4 py-3 text-sm font-medium rounded-r-md ${activeSection === "dashboard" ? "text-emerald-600 bg-emerald-50 border-l-4 border-emerald-600" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"}`}
            >
            ...
            <button
              ...
              className={`flex items-center w-full px-4 py-3 text-sm font-medium rounded-r-md ${activeSection === "rooms" ? "text-emerald-600 bg-emerald-50 border-l-4 border-emerald-600" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"}`}
            >
            ...
            <button
              ...
              className={`flex items-center w-full px-4 py-3 text-sm font-medium rounded-r-md ${activeSection === "messages" ? "text-emerald-600 bg-emerald-50 border-l-4 border-emerald-600" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"}`}
            >
            ...
            <button
              ...
              className={`flex items-center w-full px-4 py-3 text-sm font-medium rounded-r-md ${activeSection === "customer-review" ? "text-emerald-600 bg-emerald-50 border-l-4 border-emerald-600" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"}`}
            >
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="flex items-center gap-2 px-3 py-2 h-auto">
                  <Image
                    ...
                    className="rounded"
                  />
                  <span className="hidden md:inline">Mountain View Resort</span>
                  <ChevronDown className="h-4 w-4" />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end">
                <DropdownMenuItem>Lakeside Lodge</DropdownMenuItem>
                <DropdownMenuItem>City Center Suites</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          ...
          {activeSection !== "dashboard" && activeSection !== "billing" && activeSection !== "food-delivery" && (
            <div className="flex items-center justify-center h-full">
              <Card className="w-full max-w-md">
                ...
                <CardFooter>
                  <Button onClick={() => setActiveSection("dashboard")}>Return to Overview</Button>
                </CardFooter>
              </Card>
            </div>
          )}
